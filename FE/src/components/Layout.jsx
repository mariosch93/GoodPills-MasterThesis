...
const Layout = () => {
  ...
  return (
    ...
    >
      ...
      {/* αρκετό padding-top για να μη σκεπάζει το header το περιεχόμενο */}
      <main className="flex-1 w-full max-w-[98vw] mx-auto pt-12 sm:pt-16 md:pt-12 lg:pt-12">
        <div
          className={`overflow-auto max-h-full p-5 transform transition-transform duration-500 ${
