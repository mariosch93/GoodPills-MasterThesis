...
import medicineLight from "../assets/images/password_light.jpg";
                    ...
                    {csInfo ? (
                        <Stack spacing={3}>
                            <FormControl>
                                ...
                                <Input value={csInfo?.fullname || ""} readOnly />
                            </FormControl>

                            <FormControl>
                                <FormLabel>Ηλικία</FormLabel>
                                <Input value={csInfo?.age || ""} readOnly />
                            </FormControl>

                            <FormControl>
                                <FormLabel>Τηλέφωνο</FormLabel>
                                <Input value={csInfo?.phoneNumber || ""} readOnly />
                            </FormControl>

                            <FormControl>
                                <FormLabel>Πόλη</FormLabel>
                                <Input value={csInfo?.city || ""} readOnly />
                            </FormControl>

                            <FormControl>
                                <FormLabel>Διεύθυνση</FormLabel>
                                <Input value={csInfo?.address || ""} readOnly />
                            </FormControl>
                        </Stack>
                    ) : (
                ...
                >
                    ...
                    <form onSubmit={handleSubmit}>
                        <Stack spacing={3}>
                            ...
                            <FormControl required>
                                ...
                                <Input name="confirmNewPassword" type="password" placeholder="*********" />
                            </FormControl>
                    ...
                    <Box sx={{ mt: 4, textAlign: "center" }}>
                        <Typography level="body-lg">
                            ...
                            <Link onClick={() => navigate("/home")} level="title-lg" sx={{ cursor: "pointer" }}>
                                Go back
                            </Link>
                        </Typography>
                    </Box>
