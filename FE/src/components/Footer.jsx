          ...
          <Grid size={{ xs: 12, md: 8 }}>
            <Box sx={{ mb: 1 }}>
              ...
              <Typography variant="body2">
                ...
                <br />Η εφαρμογή αποτελεί πρότυπο ηλεκτρονικού φαρμακείου, όπου
                οι χρήστες μπορούν να εγγράφονται, να περιηγούνται σε
                φαρμακευτικά προϊόντα και να υποβάλλουν παραγγελίες, ενώ ο
                διαχειριστής έχει πλήρη δυνατότητα διαχείρισης του καταλόγου
                προϊόντων και των σχετικών συναλλαγών.
              </Typography>
            </Box>
          </Grid>
          <Grid size={4}>
